...
export const INJECT_VERSION = "v0.29.9"; // bump:0.5.37 关闭防抖重置根治——原!item 每次mousemove清+重起200ms,手微动永重置→停手后+200ms才关=真延迟源(用户实测不止0.25s);改单次布防(!hideTimer判)+disarmHide置null单点
